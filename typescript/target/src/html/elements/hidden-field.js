...
class HiddenField extends abstract_element_1.default {
    constructor(locator, context) {
        super(locator, context);
    }
    changeValue(value) {
        return __awaiter(this, void 0, void 0, function* () {
            yield factory_provider_1.FactoryProvider.getWebDriverFactory().getElementDriver().setAttributeValueOfElement(this, 'value', value);
        });
    }
}
