import { isUndefined, repeat } from 'lodash'
...
const outDir: string = 'target'

const specFile = function (): string {
  let sf: string = CliUtils.getSpecFileFromCli()
  return sf === 'undefined' ? sf : sf.startsWith(outDir)
    ? sf : outDir + '/test/specs/' + sf
}
